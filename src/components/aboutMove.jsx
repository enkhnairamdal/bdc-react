				...
				<div className="row">
					<div className="col-lg-6 col-md-12 flex-align mb-r-30 wow fadeInLeft">
						<div className="work-box">
							<h3 className="work-process-title pb-25 about-items-p">Койн гаргагч <span style={{wordSpacing: "-24px"}}>"Эм Ди Кэй Ай"</span> компанийн тухай </h3>
							<p className="work-des grey">"Эм Ди Кэй Ай" компани нь анх 2008 онд үл хөдлөх хөрөнгө, барилгын чиглэлээр үйл ажиллагаа явуулж эхэлсэн. Улмаар 2016 онд DASystem ХХК-тай Fintech, санхүүгийн чиглэлээр хамтран ажиллаж эхэлснээр биткойн олборлолт, хөрөнгө оруулалт, блокчэйн салбаруудад олон улсын түвшинд төсөл хөтөлбөрүүд амжилттай хэрэгжүүлэн ажиллаж байна.
Алсын хараа: Олон улсын хамтрагч түншүүдтэйгээ хамтран, хэрэглэгч, харилцагчдадаа аюулгүй, ил тод хөрөнгө оруулалтын платформд дэлхийн хаанаас ч оролцох боломжийг олгож, mineral санхүүгийн шинэ эрин үеийг бий болгох юм.  </p>
						...
						<div className="work-box">
							...
							<p className="work-des grey about-items-p">Уг компани анх 2011 онд үүсгэн байгуулагдсан бөгөөд бага цахилгаан зарцуулан, өндөр хүчин чадлаар биткойн олборлогч Block Box үйлдвэрлэн гаргадаг. Энэ чиглэлийн ижил төстэй үйлдвэрлэгчдээсээ чанар, технологи, найдвартай байдлаараа тэргүүлэгч компани юм. 
								<ul>
									...
									<li>• Хэмжээ: 40 тонны контейнер</li>
